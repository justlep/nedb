...
import {hasOwnProp, isDate, isRegExp} from './customUtils.js';

const modifierFunctions = Object.create(null);
const lastStepModifierFunctions = Object.create(null);
const logicalOperators = Object.create(null);
const arrayComparisonFunctions = Object.create(null);
const comparisonFunctions = Object.create(null);
...
lastStepModifierFunctions.$set = function (obj, field, value) {
    if (obj && obj !== true) {
        obj[field] = value; // throws when assigning to booleans
    }
};
...
Object.keys(lastStepModifierFunctions).forEach(modifier => modifierFunctions[modifier] = createModifierFunction(modifier));
...
export function areThingsEqual(a, b) {
    ...
    if (a === null || aType === 'string' || aType === 'boolean' || aType === 'number' ||
        b === null || bType === 'string' || bType === 'boolean' || bType === 'number') {
        return a === b;
    }
