...
export class Datastore extends EventEmitter {
    ...
    constructor({filename, timestampData, inMemoryOnly, autoload, onload, beforeDeserialization, afterSerialization, 
        ...
        this.idIndex = new UniqueStringIndex('_id'); // was: new Index({fieldName: '_id', unique: true});
        
        this.indexes._id = this.idIndex;
    ...
    getCandidates(query, callback, dontExpireStaleDocs = false) {
        ...
        legacyWaterfall([
            ...
            (cb) => {
                ...
                if (allQueryKeys.length === 1 && typeof query._id === 'string') {
                    return cb(null, this.idIndex.getMatchingForSingle(query._id));
                }
