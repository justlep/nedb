...
export class Datastore extends EventEmitter {
    ...
    count(query, callback) {
        let cursor = new Cursor(this, query, (err, docs, cb) => err ? cb(err) : cb(null, docs.length));
    ...
    find(query, projection, callback) {
        ...
        let cursor = new Cursor(this, query, (err, docs, cb) => err ? cb(err) : cb(null, docs.map(cloneDeep)), projection);
