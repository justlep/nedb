...
export class Datastore extends EventEmitter {
    ...
    constructor({filename, timestampData, inMemoryOnly, autoload, onload, beforeDeserialization, afterSerialization, 
        ...
        /** @type {Object.<string, NedbIndex>} - mapping fieldName -> Index */
        this.indexes = Object.create(null);
        
        this.indexes._id = new UniqueStringIndex('_id'); // was Index({fieldName: '_id', unique: true});
    ...
    createNewId() {
        ...
        do {
            id = generateUid(16);
        } while (this.indexes._id.getMatching(id).length); // TODO 
        return id;
    }
